  ...
  static readonly Presets = {
    ...
    fileWithRetries: (userId = 'user-test-123') =>
      FileFixture.createFileDbRecord({
        ...
        last_error: 'OCR extraction timeout after 30 seconds',
        failed_at: null,
      }),
    ...
    permanentlyFailedFile: (userId = 'user-test-123') =>
      FileFixture.createFileDbRecord({
        ...
        last_error: 'Maximum retries exceeded: OCR service unavailable',
    ...
    embeddingFailedFile: (userId = 'user-test-123') =>
      FileFixture.createFileDbRecord({
        ...
        pipeline_status: 'failed',
        pipeline_retry_count: 2,
        last_error: 'Azure OpenAI rate limit exceeded',
