/**
 * FileRepositoryV2 — State Machine Integration Tests (PRD-01)
 *
 ...
 *
 * @module __tests__/integration/files/v2/FileRepositoryV2
 */
...
describe('FileRepositoryV2 — State Machine Integration (PRD-01)', () => {
  setupDatabaseForTests({ skipRedis: true });

  let helper: V2PipelineTestHelper;
  let repo: FileRepositoryV2;
  let testUser: { id: string; email: string };

  beforeEach(async () => {
    helper = createV2PipelineTestHelper();
    repo = new FileRepositoryV2();
