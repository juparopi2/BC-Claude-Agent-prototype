...
describe('MaintenanceWorker', () => {
  let MaintenanceWorker: typeof import('@/infrastructure/queue/workers/v2/MaintenanceWorker').MaintenanceWorker;
  ...
  beforeEach(async () => {
    ...
    const mod = await import('@/infrastructure/queue/workers/v2/MaintenanceWorker');
