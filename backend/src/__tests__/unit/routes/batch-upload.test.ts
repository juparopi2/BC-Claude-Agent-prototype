 ...
 *
 * Endpoints tested:
 * - POST   /api/uploads/batches                              → createBatch
 * - POST   /api/uploads/batches/:batchId/files/:fileId/confirm → confirmFile
 * - GET    /api/uploads/batches/:batchId                       → getBatchStatus
 * - DELETE /api/uploads/batches/:batchId                       → cancelBatch
 *
...
vi.mock('@/services/files/batch', () => ({
  getBatchUploadOrchestrator: vi.fn(() => mockOrchestrator),
...
import batchRoutes from '@/routes/uploads/batch.routes';
...
describe('Batch Upload Routes V2 (PRD-03)', () => {
  ...
  beforeEach(() => {
    ...
    app.use('/api/uploads/batches', batchRoutes);
  });

  // ============================================
  // POST / (createBatch)
  // ============================================
  describe('POST /api/uploads/batches - Create Batch', () => {
  ...
  // ============================================
  describe('POST /api/uploads/batches/:batchId/files/:fileId/confirm - Confirm File', () => {
    it('should return 200 on successful file confirmation', async () => {
      ...
      // Act
      const response = await request(app)
        .post('/api/uploads/batches/BATCH-1234-5678-9ABC-DEF012345678/files/FILE-AAAA-BBBB-CCCC-DDDDEEEEEEEE/confirm')
        .expect(200);
    ...
    it('should return 404 when batch not found', async () => {
      ...
      // Act
      const response = await request(app)
        .post('/api/uploads/batches/BATCH-INVALID/files/FILE-AAAA-BBBB-CCCC-DDDDEEEEEEEE/confirm')
        .expect(404);
  ...
  // ============================================
  describe('GET /api/uploads/batches/:batchId - Get Batch Status', () => {
    it('should return 200 with batch status', async () => {
      ...
      // Act
      const response = await request(app)
        .get('/api/uploads/batches/BATCH-1234-5678-9ABC-DEF012345678')
        .expect(200);
    ...
    it('should return 404 when batch not found', async () => {
      ...
      // Act
      const response = await request(app)
        .get('/api/uploads/batches/BATCH-INVALID')
        .expect(404);
  ...
  // ============================================
  describe('DELETE /api/uploads/batches/:batchId - Cancel Batch', () => {
    it('should return 200 on successful batch cancellation', async () => {
      ...
      // Act
      const response = await request(app)
        .delete('/api/uploads/batches/BATCH-1234-5678-9ABC-DEF012345678')
        .expect(200);
    ...
    it('should return 404 when batch not found', async () => {
      ...
      // Act
      const response = await request(app)
        .delete('/api/uploads/batches/BATCH-INVALID')
        .expect(404);
