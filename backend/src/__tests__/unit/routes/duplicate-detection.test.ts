 ...
 *
 * Endpoint tested:
 * - POST /api/uploads/check-duplicates - Batch duplicate check before upload
 *
...
vi.mock('@/services/files/DuplicateDetectionService', () => {
  ...
  return {
    DuplicateDetectionService: MockDuplicateDetectionService,
    getDuplicateDetectionService: vi.fn(() => new MockDuplicateDetectionService()),
  };
});
...
describe('Duplicate Detection Route (PRD-02)', () => {
  ...
  // Success Cases
  // ============================================
  describe('POST /api/uploads/check-duplicates - Success', () => {
  ...
  // ============================================
  describe('POST /api/uploads/check-duplicates - Validation Errors', () => {
  ...
  // ============================================
  describe('POST /api/uploads/check-duplicates - Authentication', () => {
  ...
  // Service Error Cases
  // ============================================
  describe('POST /api/uploads/check-duplicates - Service Errors', () => {
  ...
  // Edge Cases
  // ============================================
  describe('POST /api/uploads/check-duplicates - Edge Cases', () => {
  ...
  // ============================================
  describe('POST /api/uploads/check-duplicates - Response Contract', () => {
