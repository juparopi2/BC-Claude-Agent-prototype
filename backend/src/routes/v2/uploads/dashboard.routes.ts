 ...
 *
 * API endpoints for observability and error recovery of the V2 upload pipeline.
 *
 * Endpoints:
 ...
 *
 * @module routes/v2/uploads/dashboard
 */
...
router.get('/', async (req, res) => {
  try {
    ...
    // Get queue depths for V2 pipeline queues
...
/**
 * POST /api/v2/uploads/dashboard/stuck/:fileId/retry
