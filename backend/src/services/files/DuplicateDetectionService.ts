 ...
 *
 * @module services/files/DuplicateDetectionService
 */
...
const logger = createChildLogger({ service: 'DuplicateDetectionService' });
...
export class DuplicateDetectionService {
  ...
  /**
   * Scope 1: Storage — files already processed (ready or failed)
   */
...
let instance: DuplicateDetectionService | undefined;

/**
 * Get the DuplicateDetectionService singleton.
 */
 ...
 * @internal
 */
export function __resetDuplicateDetectionService(): void {
  instance = undefined;
}
