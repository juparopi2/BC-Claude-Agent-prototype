 ...
 *
 * @module services/files/FolderDuplicateDetectionService
 */
...
const logger = createChildLogger({ service: 'FolderDuplicateDetectionService' });

// ============================================================================
// Service
// ============================================================================

export class FolderDuplicateDetectionService {
  ...
  ): Promise<CheckFolderDuplicatesResponse> {
    if (inputs.length === 0) {
...
let instance: FolderDuplicateDetectionService | undefined;

export function getFolderDuplicateDetectionService(): FolderDuplicateDetectionService {
  if (!instance) {
    instance = new FolderDuplicateDetectionService();
  }
  return instance;
}

export function __resetFolderDuplicateDetectionService(): void {
  instance = undefined;
}
