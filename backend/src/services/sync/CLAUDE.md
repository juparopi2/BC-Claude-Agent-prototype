...
| `SyncReconciliationService` | PRD-300. Cron hourly (24x/day) + on-demand per-user: compare DB ready files vs Search index, detect drift, optional auto-repair. On-demand always repairs. |
