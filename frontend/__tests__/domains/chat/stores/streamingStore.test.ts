...
describe('StreamingStore', () => {
  ...
  // ============================================================================
  // Gap #7 Fix: Paused State
  // ============================================================================

  describe('setPaused (Gap #7 Fix)', () => {
    it('should set paused state with reason', () => {
      act(() => {
        getStreamingStore().getState().startStreaming();
        getStreamingStore().getState().setPaused(true, 'Waiting for approval');
      });
    ...
    it('should resume streaming when setPaused(false)', () => {
      act(() => {
        getStreamingStore().getState().startStreaming();
        getStreamingStore().getState().setPaused(true, 'Paused');
      });

      expect(getStreamingStore().getState().isPaused).toBe(true);
    ...
    it('should clear paused state on markComplete', () => {
      act(() => {
        getStreamingStore().getState().startStreaming();
        getStreamingStore().getState().setPaused(true, 'Waiting');
        getStreamingStore().getState().markComplete();
      });
    ...
    it('should clear paused state on reset', () => {
      act(() => {
        getStreamingStore().getState().startStreaming();
        getStreamingStore().getState().setPaused(true, 'Waiting');
        getStreamingStore().getState().reset();
