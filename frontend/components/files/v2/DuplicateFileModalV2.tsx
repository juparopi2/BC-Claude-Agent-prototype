...
/**
 * DuplicateFileModalV2
 *
 * Three-scope duplicate resolution dialog for V2 uploads.
 * Shows scope badge, match type, and existing file info.
 *
 * @module components/files/v2/DuplicateFileModalV2
 */
...
} from '@/src/domains/files/stores/v2/duplicateStoreV2';
 ...
 */
export function DuplicateFileModalV2() {
  ...
  const handleAction = (action: DuplicateActionV2) => {
        ...
        <div className="space-y-3 py-4">
          ...
          {remainingCount > 1 && (
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="apply-all-v2" className="text-sm">
