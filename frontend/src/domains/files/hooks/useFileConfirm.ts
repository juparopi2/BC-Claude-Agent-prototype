 ...
 *
 * @module domains/files/hooks/useFileConfirm
 */
 ...
 */
export function useFileConfirm() {
  const markFileConfirmed = useBatchUploadStore((s) => s.markFileConfirmed);
  const markFileFailed = useBatchUploadStore((s) => s.markFileFailed);
