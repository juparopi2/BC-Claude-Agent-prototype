...
import type { BatchFileState } from '../../stores/v2/batchUploadStoreV2';
...
const EMPTY_PROGRESS: UploadProgressV2 = {
  overallProgress: 0,
  uploadProgress: 0,
 ...
 */
export function computeBatchProgress(files: Map<string, BatchFileState>): UploadProgressV2 {
