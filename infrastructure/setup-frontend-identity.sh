#!/bin/bash
################################################################################
# Setup Frontend Container App Managed Identity Permissions
################################################################################
# This script configures the necessary permissions for the Frontend Container
# App's system-assigned managed identity to access Azure Container Registry.
#
# This script should be executed ONCE after the Frontend Container App is
# created for the first time.
#
# Prerequisites:
# - Frontend Container App must exist and have system-assigned identity enabled
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Setup Frontend Container App Managed Identity${NC}"
echo -e "${BLUE}========================================${NC}\n"
...
echo -e "${GREEN}========================================${NC}"
echo -e ""
echo -e "The Frontend Container App managed identity now has:"
echo -e "  ✅ AcrPull access to $ACR_NAME"
echo -e ""
echo -e "${YELLOW}Next steps:${NC}"
echo -e "  1. The Frontend Container App can now pull images from ACR"
echo -e "  2. Re-run the GitHub Actions workflow to complete deployment"
echo -e "  3. This script only needs to be run once per Container App"
echo -e ""
echo -e "${BLUE}To update the Frontend Container App:${NC}"
